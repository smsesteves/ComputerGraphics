...
void Board::display()
{
	...
	for(unsigned int z=0;z<Jogador1.size();z++)
	{
		...
		cout<<"\tProngs: ";
		for(int i=0;i<Jogador1[z]->getDirsSize();i++)
		{
	...
	for(unsigned int z=0;z<Jogador2.size();z++)
	{
		...
		cout<<"\tProngs: ";
		for(int i=0;i<Jogador2[z]->getDirsSize();i++)
		{
...
int Board::getXbyId(int player, int id)
{
	if(player==1)
	{
		for(unsigned int i=0;i<Jogador1.size();i++)
		{
	...
	{
		for(unsigned int i=0;i<Jogador2.size();i++)
		{
